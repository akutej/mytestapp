...
# Liste der Variablen für chance und risk (coreteam & nonecoreteam)
variables_ct_nct <- list(
  "chance.classic.ct.IMPACT" = chance.classic.ct.IMPACT,
  "chance.graphic.ct.IMPACT" = chance.graphic.ct.IMPACT,
  "chance.classic.ct.OCCURRENCE" = chance.classic.ct.OCCURRENCE,
  "chance.graphic.ct.OCCURRENCE" = chance.graphic.ct.OCCURRENCE,
  "risk.classic.ct.IMPACT" = risk.classic.ct.IMPACT,
  "risk.graphic.ct.IMPACT" = risk.graphic.ct.IMPACT,
  "risk.classic.ct.OCCURRENCE" = risk.classic.ct.OCCURRENCE,
  "risk.graphic.ct.OCCURRENCE" = risk.graphic.ct.OCCURRENCE,
  
  "chance.classic.nct.IMPACT" = chance.classic.nct.IMPACT,
  "chance.graphic.nct.IMPACT" = chance.graphic.nct.IMPACT,
  "chance.classic.nct.OCCURRENCE" = chance.classic.nct.OCCURRENCE,
  "chance.graphic.nct.OCCURRENCE" = chance.graphic.nct.OCCURRENCE,
  "risk.classic.nct.IMPACT" = risk.classic.nct.IMPACT,
  "risk.graphic.nct.IMPACT" = risk.graphic.nct.IMPACT,
  "risk.classic.nct.OCCURRENCE" = risk.classic.nct.OCCURRENCE,
  "risk.graphic.nct.OCCURRENCE" = risk.graphic.nct.OCCURRENCE
)

# Berechnung von Mittelwert und Standardabweichung mit Rundung für coreteam & nonecoreteam
results_ct_nct <- data.frame(
  Variable = names(variables_ct_nct),
  Mean = round(sapply(variables_ct_nct, mean, na.rm = TRUE), 3),
  SD = round(sapply(variables_ct_nct, sd, na.rm = TRUE), 3)
)

# Ausgabe des DataFrames für coreteam & nonecoreteam
print(results_ct_nct)
...
# Liste der Variablen
variables <- list(
  "chance.classic.admi.IMPACT" = chance.classic.admi.IMPACT,
  "chance.graphic.admi.IMPACT" = chance.graphic.admi.IMPACT,
  "chance.classic.care.IMPACT" = chance.classic.care.IMPACT,
  "chance.graphic.care.IMPACT" = chance.graphic.care.IMPACT,
  "chance.classic.mana.IMPACT" = chance.classic.mana.IMPACT,
  "chance.graphic.mana.IMPACT" = chance.graphic.mana.IMPACT,
  "chance.classic.medi.IMPACT" = chance.classic.medi.IMPACT,
  "chance.graphic.medi.IMPACT" = chance.graphic.medi.IMPACT,
  "chance.classic.tech.IMPACT" = chance.classic.tech.IMPACT,
  "chance.graphic.tech.IMPACT" = chance.graphic.tech.IMPACT,
  
  "chance.classic.admi.OCCURRENCE" = chance.classic.admi.OCCURRENCE,
  "chance.graphic.admi.OCCURRENCE" = chance.graphic.admi.OCCURRENCE,
  "chance.classic.care.OCCURRENCE" = chance.classic.care.OCCURRENCE,
  "chance.graphic.care.OCCURRENCE" = chance.graphic.care.OCCURRENCE,
  "chance.classic.mana.OCCURRENCE" = chance.classic.mana.OCCURRENCE,
  "chance.graphic.mana.OCCURRENCE" = chance.graphic.mana.OCCURRENCE,
  "chance.classic.medi.OCCURRENCE" = chance.classic.medi.OCCURRENCE,
  "chance.graphic.medi.OCCURRENCE" = chance.graphic.medi.OCCURRENCE,
  "chance.classic.tech.OCCURRENCE" = chance.classic.tech.OCCURRENCE,
  "chance.graphic.tech.OCCURRENCE" = chance.graphic.tech.OCCURRENCE
)

# Berechnung von Mittelwert und Standardabweichung mit Rundung
results <- data.frame(
  Variable = names(variables),
  Mean = round(sapply(variables, mean, na.rm = TRUE), 3),
  SD = round(sapply(variables, sd, na.rm = TRUE), 3)
)
...
# Liste der Variablen für risk
variables_risk <- list(
  "risk.classic.admi.IMPACT" = risk.classic.admi.IMPACT,
  "risk.graphic.admi.IMPACT" = risk.graphic.admi.IMPACT,
  "risk.classic.care.IMPACT" = risk.classic.care.IMPACT,
  "risk.graphic.care.IMPACT" = risk.graphic.care.IMPACT,
  "risk.classic.mana.IMPACT" = risk.classic.mana.IMPACT,
  "risk.graphic.mana.IMPACT" = risk.graphic.mana.IMPACT,
  "risk.classic.medi.IMPACT" = risk.classic.medi.IMPACT,
  "risk.graphic.medi.IMPACT" = risk.graphic.medi.IMPACT,
  "risk.classic.tech.IMPACT" = risk.classic.tech.IMPACT,
  "risk.graphic.tech.IMPACT" = risk.graphic.tech.IMPACT,
  
  "risk.classic.admi.OCCURRENCE" = risk.classic.admi.OCCURRENCE,
  "risk.graphic.admi.OCCURRENCE" = risk.graphic.admi.OCCURRENCE,
  "risk.classic.care.OCCURRENCE" = risk.classic.care.OCCURRENCE,
  "risk.graphic.care.OCCURRENCE" = risk.graphic.care.OCCURRENCE,
  "risk.classic.mana.OCCURRENCE" = risk.classic.mana.OCCURRENCE,
  "risk.graphic.mana.OCCURRENCE" = risk.graphic.mana.OCCURRENCE,
  "risk.classic.medi.OCCURRENCE" = risk.classic.medi.OCCURRENCE,
  "risk.graphic.medi.OCCURRENCE" = risk.graphic.medi.OCCURRENCE,
  "risk.classic.tech.OCCURRENCE" = risk.classic.tech.OCCURRENCE,
  "risk.graphic.tech.OCCURRENCE" = risk.graphic.tech.OCCURRENCE
)

# Berechnung von Mittelwert und Standardabweichung mit Rundung für risk
results_risk <- data.frame(
  Variable = names(variables_risk),
  Mean = round(sapply(variables_risk, mean, na.rm = TRUE), 3),
  SD = round(sapply(variables_risk, sd, na.rm = TRUE), 3)
)

# Ausgabe des DataFrames für risk
print(results_risk)
