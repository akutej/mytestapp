...
library(ggplot2)
library(tibble)
dataframe <- read.csv("myapp/files/80_distances/distances_pValue.csv")
#print (dataframe)
...
#print (dataframe.IMP.area.weighted)
#p_values.IMP.classic.area <- dataframe.IMP.classic.area$pValue 
#p_values.OCC.classic.area <- dataframe.OCC.classic.area$pValue 
#p_values.IMP.classic.weighted <- dataframe.IMP.classic.weighted$pValue 
#p_values.OCC.classic.weighted <- dataframe.OCC.classic.weighted$pValue 
#p_values.IMP.classic.center <- dataframe.IMP.classic.center$pValue 
#p_values.OCC.classic.center <- dataframe.OCC.classic.center$pValue 
#p_values.IMP.classic.centertogrid <- dataframe.IMP.classic.centertogrid$pValue 
#p_values.OCC.classic.centertogrid <- dataframe.OCC.classic.centertogrid$pValue 
#p_values.IMP.classic.reachedgrid <- dataframe.IMP.classic.reachedgrid$pValue 
#p_values.OCC.classic.reachedgrid <- dataframe.OCC.classic.reachedgrid$pValue 
#p_values.IMP.classic.pooling <- dataframe.IMP.classic.pooling$pValue 
#p_values.OCC.classic.pooling <- dataframe.OCC.classic.pooling$pValue 
p_values.IMP.area.center <- dataframe.IMP.area.center$pValue 
#p_values.OCC.area.center <- dataframe.OCC.area.center$pValue 
#p_values.IMP.area.centertogrid <- dataframe.IMP.area.centertogrid$pValue 
#p_values.OCC.area.centertogrid <- dataframe.OCC.area.centertogrid$pValue 
#p_values.IMP.area.reachedgrid <- dataframe.IMP.area.reachedgrid$pValue 
#p_values.OCC.area.reachedgrid <- dataframe.OCC.area.reachedgrid$pValue 
#p_values.IMP.area.weighted <- dataframe.IMP.area.weighted$pValue 
#p_values.OCC.area.weighted <- dataframe.OCC.area.weighted$pValue 
#p_values.IMP.area.pooling <- dataframe.IMP.area.pooling$pValue 
#p_values.OCC.area.pooling <- dataframe.OCC.area.pooling$pValue 
#p_values.IMP.center.centertogrid <- dataframe.IMP.center.centertogrid$pValue 
#p_values.OCC.center.centertogrid <- dataframe.OCC.center.centertogrid$pValue 
#p_values.IMP.center.reachedgrid <- dataframe.IMP.center.reachedgrid$pValue 
#p_values.OCC.center.reachedgrid <- dataframe.OCC.center.reachedgrid$pValue 
#p_values.IMP.center.weighted <- dataframe.IMP.center.weighted$pValue 
#p_values.OCC.center.weighted <- dataframe.OCC.center.weighted$pValue 
#p_values.IMP.center.pooling <- dataframe.IMP.center.pooling$pValue 
#p_values.OCC.center.pooling <- dataframe.OCC.center.pooling$pValue 
#p_values.IMP.centertogrid.reachedgrid <- dataframe.IMP.centertogrid.reachedgrid$pValue 
#p_values.OCC.centertogrid.reachedgrid <- dataframe.OCC.centertogrid.reachedgrid$pValue 
#p_values.IMP.centertogrid.weighted <- dataframe.IMP.centertogrid.weighted$pValue 
#p_values.OCC.centertogrid.weighted <- dataframe.OCC.centertogrid.weighted$pValue 
#p_values.IMP.centertogrid.pooling <- dataframe.IMP.centertogrid.pooling$pValue 
#p_values.OCC.centertogrid.pooling <- dataframe.OCC.centertogrid.pooling$pValue 
#p_values.IMP.reachedgrid.weighted <- dataframe.IMP.reachedgrid.weighted$pValue 
#p_values.OCC.reachedgrid.weighted <- dataframe.OCC.reachedgrid.weighted$pValue 
#p_values.IMP.reachedgrid.pooling <- dataframe.IMP.reachedgrid.pooling$pValue 
#p_values.OCC.reachedgrid.pooling <- dataframe.OCC.reachedgrid.pooling$pValue 
#p_values.IMP.weighted.pooling <- dataframe.IMP.weighted.pooling$pValue 
#p_values.OCC.weighted.pooling <- dataframe.OCC.weighted.pooling$pValue 
...
#chi_sq_statistic <- -2 * sum(log(p_values.IMP.area.center))
#combined_p_value <- pchisq(chi_sq_statistic, df = 2 * length(p_values.IMP.area.center), lower.tail = FALSE)
#print (combined_p_value)
#chi_sq_statistic <- -2 * sum(log(p_values.IMP.center.weighted))
#combined_p_value <- pchisq(chi_sq_statistic, df = 2 * length(p_values.IMP.center.weighted), lower.tail = FALSE)
#print (combined_p_value)

scentext <- paste0("p_values")
scenfile <- paste0("myapp/files/80_distances/pValue_methods_all.xlsx")

write.csv(combined_p_values_df, file = paste0("myapp/files/80_distances/pValue_methods_all.csv"), row.names = TRUE)
