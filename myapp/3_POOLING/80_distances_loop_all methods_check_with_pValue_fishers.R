...
library(ggplot2)
library(tibble)
weighteddataframe <- read.csv("myapp/files/80_distances/weighted_pValue.csv")
...
scenfile <- paste0("myapp/files/80_distances/pValue_fisher.xlsx")

write.csv(combined_p_values_df, file = paste0("myapp/files/80_distances/pValue_fisher.csv"), row.names = TRUE)
...
scenfile <- paste0("myapp/files/80_distances/weighted_pValue_fisher.xlsx")

write.csv(w.combined_p_values_df, file = paste0("myapp/files/80_distances/weighted_pValue_fisher.csv"), row.names = TRUE)
