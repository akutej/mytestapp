...
df.scenario <- read.csv(file = 'myapp/files/5_heatmap_step2/merged_Scenario281.csv', header=TRUE) #importiere das answers file
...
write.csv(df.basic, "myapp/files/6_heatmap_step3/heatmap_281_switched.csv", row.names=TRUE)
write.xlsx(df.basic,'myapp/files/6_heatmap_step3/heatmap_281_switched.xlsx', rowNames=TRUE)
