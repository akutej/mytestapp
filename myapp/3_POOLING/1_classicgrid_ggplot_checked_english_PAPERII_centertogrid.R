...
thisis <- ggplot()+ 
  ...
  geom_rect(aes(xmin=0, xmax=80, ymin=0, ymax=80),fill="#FFF4B7", color="black", alpha=1)+
  ...
  geom_rect(aes(xmin=80, xmax=160, ymin=160, ymax=240),fill="#F8D074", color="black", alpha=1)+
  ...
  geom_rect(aes(xmin=160, xmax=240, ymin=80, ymax=160),fill="#F5A100", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=160, ymax=240),fill="#7D0025", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=240, ymax=320),fill="#F5A100", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=320, ymax=400),fill="#FBE49A", color="black", alpha=1)+ #1.3
  geom_rect(aes(xmin=240, xmax=320, ymin=0, ymax=80),fill="#FFF4B7", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=80, ymax=160),fill="#C32200", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=160, ymax=240),fill="#F5A100", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=240, ymax=320),fill="#F5A100", color="black", alpha=1)+
  ...
  geom_rect(aes(xmin=320, xmax=400, ymin=80, ymax=160),fill="#F7BA3C", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=160, ymax=240),fill="#E13C00", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=240, ymax=320),fill="#F5A100", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=320, ymax=400),fill="#C32200", color="black", alpha=1)+ #1.8
...
scenfile <- (paste0("myapp/pictures/paper2/", scentext,"_heat_centertogrid",".png"))  
