...
thisis <- ggplot()+ 
  ...
  xlim(-130,400)+
  ylim(0,530)+
  geom_rect(aes(xmin=-80, xmax=0, ymin=0, ymax=80),fill="lightgrey", color="black", alpha=1)+
  geom_rect(aes(xmin=-80, xmax=0, ymin=80, ymax=160),fill="lightgrey", color="black", alpha=1)+
  geom_rect(aes(xmin=-80, xmax=0, ymin=160, ymax=240),fill="lightgrey", color="black", alpha=1)+
  geom_rect(aes(xmin=-80, xmax=0, ymin=240, ymax=320),fill="lightgrey", color="black", alpha=1)+
  geom_rect(aes(xmin=-80, xmax=0, ymin=320, ymax=400),fill="lightgrey", color="black", alpha=1)+
  geom_rect(aes(xmin=-130, xmax=-80, ymin=0, ymax=400),fill="grey", color="black", alpha=1)+
  ...
  geom_rect(aes(xmin=80, xmax=160, ymin=80, ymax=160),fill="#FFF4B7", color="black", alpha=1)+
  geom_rect(aes(xmin=80, xmax=160, ymin=160, ymax=240),fill="#FFF4B7", color="black", alpha=1)+
  geom_rect(aes(xmin=80, xmax=160, ymin=240, ymax=320),fill="#FFFFC8", color="black", alpha=1)+
  geom_rect(aes(xmin=80, xmax=160, ymin=320, ymax=400),fill="#FFFFC8", color="black", alpha=1)+ #1.2
  geom_rect(aes(xmin=160, xmax=240, ymin=0, ymax=80),fill="#FFFFC8", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=80, ymax=160),fill="#FFF4B7", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=160, ymax=240),fill="#F7BA3C", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=240, ymax=320),fill="#F7BA3C", color="black", alpha=1)+
  geom_rect(aes(xmin=160, xmax=240, ymin=320, ymax=400),fill="#FFF4B7", color="black", alpha=1)+ #1.3
  geom_rect(aes(xmin=240, xmax=320, ymin=0, ymax=80),fill="#FFFFC8", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=80, ymax=160),fill="#F8D074", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=160, ymax=240),fill="#E13C00", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=240, ymax=320),fill="#7D0025", color="black", alpha=1)+
  geom_rect(aes(xmin=240, xmax=320, ymin=320, ymax=400),fill="#FFF4B7", color="black", alpha=1)+ #1.4
  geom_rect(aes(xmin=320, xmax=400, ymin=0, ymax=80),fill="#FFFFC8", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=80, ymax=160),fill="#FFF4B7", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=160, ymax=240),fill="#F8D074", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=240, ymax=320),fill="#FFFFC8", color="black", alpha=1)+
  geom_rect(aes(xmin=320, xmax=400, ymin=320, ymax=400),fill="#FFFFC8", color="black", alpha=1)+ #1.8
...
print(thisis)
thisis <- thisis +  theme_void() +  theme(plot.margin = unit(c(-1.5, -1, -1, -1), "cm"))+ ggtitle("")
#scenfile <- (paste0("myapp/pictures/1_classicgrid_otitle/", scentext,"_heat_",actualtype,".png"))
scenfile <- (paste0("myapp/pictures/1_classicgrid_otitle/", scentext,"_heat_",".png"))  

ggsave(filename = scenfile,plot = thisis, device = "png", width = 25, height = 25, units = "cm",dpi = 300, limitsize = FALSE,bg = "transparent")
}
