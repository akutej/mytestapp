...
for (anz in 1:numberscenarios) {
  ...
  filetitleImpact <- (paste0("myapp/pictures/31_histogramms_graphical_eot/",scentext,"- Impact.png"))
  filetitleOcc <- (paste0("myapp/pictures/31_histogramms_graphical_eot/",scentext,"- Occurrence.png"))
  
  

  bin_grenzen <- seq(0, 100, by = 0.25)
  ...
  hist(LIKELIHOOD,breaks = bin_grenzen, main = "", xlab = "Occurrence value", ylab = "Frequency", xlim = c(0, 100), col = "lightblue", border = "black")
  dev.off()
