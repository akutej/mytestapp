...
library(ggplot2)
library(tibble)
weighteddataframe <- read.csv("myapp/pictures/paper2/distances_pValue_Risks.csv")
dataframe <- read.csv("myapp/pictures/paper2/distances_pValue_Risks.csv")
#print (dataframe)
...
scenfile <- paste0("myapp/pictures/paper2/pValue_fisher_RISKS.xlsx")

write.csv(combined_p_values_df, file = paste0("myapp/pictures/paper2/pValue_fisher_RISKS.csv"), row.names = TRUE)
...
scenfile <- paste0("myapp/pictures/paper2/weighted_pValue_fisher_RISKS.xlsx")

write.csv(w.combined_p_values_df, file = paste0("myapp/pictures/paper2/weighted_pValue_fisher_RISKS.csv"), row.names = TRUE)
