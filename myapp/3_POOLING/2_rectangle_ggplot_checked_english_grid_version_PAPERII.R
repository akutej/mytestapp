...
x_ticks <- seq(0, 380, 80)
y_ticks <- seq(0, 380, 80)
...
thisis <- ggplot() + 
  ...
  xlim(-100,400) +
  ylim(0,500) +
  geom_segment(aes(x = x_ticks, y = 0, xend = x_ticks, yend = 400), color = "black", linetype = "dashed")+
  geom_segment(aes(x = 0, y = y_ticks, xend = 400, yend = y_ticks), color = "black", linetype = "dashed")+
...
print (thisis)
#thisis <- thisis +  theme_void() +  theme(plot.margin = unit(c(0,0,0,0), "cm"))+ ggtitle("")
scenfile <- (paste0("myapp/pictures/paper2/", scentext,"_areatogrid.png"))  
ggsave(filename = scenfile,plot = thisis, device = "png", width = 23, height = 23, units = "cm",dpi=600,limitsize = FALSE)
...
#thisis2 <- thisis2 +  theme_void() +  theme(plot.margin = unit(c(-1.35,-1,-0.6,-1), "cm"))+ ggtitle("")
scenfile2 <- (paste0("myapp/pictures/paper2/", scentext,"_centertogrid_Paper2.png"))  
ggsave(filename = scenfile2,plot = thisis2, device = "png", width = 23, height = 23, units = "cm",dpi=600,limitsize = FALSE)
print (thisis2)
}
else{
...
thisis <- ggplot() + 
  ...
  geom_segment(aes(x = x_ticks, y = 0, xend = x_ticks, yend = 400), color = "black", linetype = "dashed", size = 1.2) +
  geom_segment(aes(x = x_ticks, y = 7.5, xend = x_ticks, yend = 400), color = "violet", linetype = "dashed", size = 1.2) +
  geom_segment(aes(x = 0, y = y_ticks, xend = 400, yend = y_ticks), color = "black", linetype = "dashed", size = 1.2) +
  geom_segment(aes(x = 7.5, y = y_ticks, xend = 400, yend = y_ticks), color = "violet", linetype = "dashed", size = 1.2) 




print (thisis)
scenfile <- (paste0("myapp/pictures/2_areagrid/", scentext,"_areatogrid_PAPER2.png"))  
...
print (thisis2)
scenfile2 <- (paste0("myapp/pictures/2_areagrid/", scentext,"_centertogrid_PAPER2.png"))  
