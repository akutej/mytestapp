...
for (anz in 1:number.scenarios) {
  ...
  filetitleImpact <- (paste0("myapp/pictures/paper2/",scentext,"_Impact_weighted.png"))
  filetitleOcc <- (paste0("myapp/pictures/paper2/",scentext,"_Occurrence_weighted.png"))
  ...
  bar_positions <- barplot(x.grouped$x,
  ...
  # Fügt manuell eine X-Achse mit den gewünschten Werten hinzu
  ...
  bar_positions <- barplot(y.grouped$x,
