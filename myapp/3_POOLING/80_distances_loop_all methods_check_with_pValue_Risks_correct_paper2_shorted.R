...
#Anpassung für weighted damit der p-Wert berechnet werden kann
      ...
      methods <- c("classic", "area", "center", "centertogrid", "reachedgrid")
      name_DF_IMP <- c("classicX_metrics", "areax", "middlegridx", "graphiccentertoclassicX_metrics", "graphic_gridreach_X_metrics")
      name_DF_IMP2 <- c("-","-","-","-","-")
      name_DF_OCC <- c("classicY_metrics", "areay", "middlegridy", "graphiccentertoclassicY_metrics", "graphic_gridreach_Y_metrics")
      name_DF_OCC2 <- c("-","-","-","-","-")
