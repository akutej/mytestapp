...
for (i in 1:numberofanswers){
  ...
  scenpic <- (paste0("myapp/pictures/17_heatmap_pixel_graphic/",scentext,"_heatmap_weight_scales.bmp"))
  ...
  write.csv(D, paste0("myapp/files/4_heatmap/", scentext,"_transformed_new_weight_scales.csv"), row.names=TRUE)
