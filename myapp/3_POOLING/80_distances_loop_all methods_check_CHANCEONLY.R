...
scenfile <- paste0("myapp/files/80_distances/distances_chance.xlsx")

write.csv(gerundeter_df, file = paste0("myapp/files/80_distances/distances_chance.csv"), row.names = TRUE)
...
scentext <- paste0("Streumaße")
scenfile <- paste0("myapp/files/80_distances/distances_aggregate1_chance.xlsx")

write.csv(summary_df, file = paste0("myapp/files/80_distances/distances_aggregate1_chance.csv"), row.names = TRUE)
...
scentext <- paste0("Streumaße")
scenfile <- paste0("myapp/files/80_distances/distances_aggregate2_chance.xlsx")

write.csv(new_summary_df, file = paste0("myapp/files/80_distances/distances_aggregate2_chance.csv"), row.names = TRUE)
