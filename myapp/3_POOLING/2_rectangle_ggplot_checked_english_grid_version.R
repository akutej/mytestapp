...
x_ticks <- seq(0, 400, 80)
y_ticks <- seq(0, 400, 80)
...
thisis <- ggplot() + 
  ...
  # hinzufügen von horizontal and vertical ticks
...
print (thisis)
scenfile <- (paste0("myapp/pictures/2_areagrid/", scentext,"_areatogrid.png"))  
...
print (thisis2)
scenfile2 <- (paste0("myapp/pictures/2_areagrid/", scentext,"_centertogrid.png"))  
