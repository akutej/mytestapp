...
for (anz in 1:numberscenarios) {
  ...
  hist(IMPACT,breaks = c(0.5,1.5,2.5,3.5,4.5,5.5), main="",xlim=c(0.5,5.5),labels = FALSE,col="lightblue",xlab = "" )
  ...
  hist(OCCURRENCE,breaks = c(0.5,1.5,2.5,3.5,4.5,5.5), main="",xlim=c(0.5,5.5),labels = FALSE,col="lightblue",xlab = "" )
