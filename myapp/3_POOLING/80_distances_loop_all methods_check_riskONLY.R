...
scenfile <- paste0("myapp/files/80_distances/distances_risk.xlsx")

write.csv(gerundeter_df, file = paste0("myapp/files/80_distances/distances_risk.csv"), row.names = TRUE)
...
scentext <- paste0("Streumaße")
scenfile <- paste0("myapp/files/80_distances/distances_aggregate1_risk.xlsx")

write.csv(summary_df, file = paste0("myapp/files/80_distances/distances_aggregate1_risk.csv"), row.names = TRUE)
...
scentext <- paste0("Streumaße")
scenfile <- paste0("myapp/files/80_distances/distances_aggregate2_risk.xlsx")

write.csv(new_summary_df, file = paste0("myapp/files/80_distances/distances_aggregate2_risk.csv"), row.names = TRUE)
