...
scenfile <- paste0("myapp/files/80_distances/distances_pValue_Chances.xlsx")

write.csv(gerundeter_df, file = paste0("myapp/files/80_distances/distances_pValue_Chances.csv"), row.names = TRUE)
...
write.csv(summary_df, file = paste0("myapp/files/80_distances/distances_aggregate1_pValue_Chances.csv"), row.names = TRUE)
...
write.csv(new_summary_df, file = paste0("myapp/files/80_distances/distances_aggregate2_pValue_Chances.csv"), row.names = TRUE)
...
scenfile <- paste0("myapp/files/80_distances/weighted_pValue_Chances.xlsx")

write.csv(special.distance.df, file = paste0("myapp/files/80_distances/weighted_pValue_Chances.csv"), row.names = TRUE)
