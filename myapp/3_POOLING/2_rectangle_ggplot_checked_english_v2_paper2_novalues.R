...
print (thisis)
scenfile <- (paste0("myapp/pictures/paper2/", scentext,"_rectangle.png"))  
#scenfile <- (paste0("myapp/pictures/2_graphicrectangle_eot/", scentext,"_rectangle-no_",actualtype,".png"))  
