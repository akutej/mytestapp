...
df <- read.csv(file = 'myapp/files/heatmap/Scenario 282_tranformed.csv', header=TRUE) #importiere das answers file
#print (df)
...
write.csv(createdf, "myapp/files/heatmap_step2/merged_Scenario282.csv", row.names=TRUE)
write.xlsx(createdf,'myapp/files/heatmap_step2/merged_Scenario282.xlsx', rowNames=TRUE)
