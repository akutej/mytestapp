...
df.scenario <- read.csv(file = 'myapp/files/heatmap_step2/merged_Scenario292.csv', header=TRUE) #importiere das answers file
...
write.csv(df.basic, "myapp/files/heatmap_step3/heatmap_292_switched.csv", row.names=TRUE)
write.xlsx(df.basic,'myapp/files/heatmap_step3/heatmap_292_switched.xlsx', rowNames=TRUE)
