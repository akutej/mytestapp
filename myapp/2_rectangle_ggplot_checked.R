...
print (thisis)
scenfile <- (paste0("myapp/pictures/2_graphicrectangle/", scentext,"_rectangle_",actualtype,".png"))  
...
print (thisis2)
scenfile2 <- (paste0("myapp/pictures/2_graphicrectangle/", scentext,"_onlycenter_",actualtype,".png"))  
