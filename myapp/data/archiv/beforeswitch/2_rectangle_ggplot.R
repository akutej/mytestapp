...
answerstable <- read.csv(file = 'myapp/Data/RQ1_test.csv', header=TRUE) #importiere das answers file
...
thisis <- ggplot() + 
  ...
  geom_text(aes(x = -15, y = 40, label = "niedrig"),size = 5,angle=90)+
  geom_text(aes(x = -15, y = 200, label = "mittel"),size = 5,angle=90)+
  geom_text(aes(x = -15, y = 360, label = "hoch"),size = 5,angle=90)+
  geom_text(aes(x = 40, y = 415, label = "niedrig"),size = 5)+
  geom_text(aes(x = 200, y = 415, label = "mittel"),size = 5)+
  geom_text(aes(x = 360, y = 415, label = "hoch"),size = 5)+
  geom_text(aes(x = 200, y = 445, label = "Auswirkung"),size = 5)+
  geom_text(aes(x = -45, y = 200, label = "Eintrittswahrscheinlichkeit"),size = 5,angle=90)#+




print (thisis)
scenfile <- (paste0("myapp/pictures/graphicrectangle/", scentext,"_rectangle_",actualtype,".png"))  
...
print (thisis2)
scenfile2 <- (paste0("myapp/pictures/graphicrectangle/", scentext,"_onlycenter_",actualtype,".png"))  
