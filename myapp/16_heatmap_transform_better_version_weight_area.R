...
for (anz in 1:numberscenarios) {
  ...
  for (m in 1:numberofanswers){
    ...
    sum.Area <- sum.Area + distance.Area
  }  
  #print (sum.Imp)
  #print (sum.Occ)
  #print (sum.Area)
...
for (i in 1:numberofanswers){
  ...
  #Uncertaintyweight <- distanceAreaUser / sum.Area
  print (UncertaintyAreaUser)
  Uncertaintyweight <- (160001 - UncertaintyAreaUser)
  ...
  D[index,"Zähler"] <- D[index,"Zähler"] + (Uncertaintyweight)
 print (AccId)
  print (Uncertaintyweight)
