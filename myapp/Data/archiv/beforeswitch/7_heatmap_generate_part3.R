...
df <- read.csv(file = 'myapp/files/heatmap_step3/heatmap_282_switched.csv', header=TRUE) #importiere das answers file
...
bmp(file="myapp/pictures/heatmap_pixel_graphic/heatmap_282.bmp", width = 1000, height = 1000, units = 'px', res = 100)
