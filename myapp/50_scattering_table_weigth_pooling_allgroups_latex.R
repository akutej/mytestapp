...
for (anz in 1:number.scenarios) {
  ...
  save_to_latex(actualscenario,
                ...
                group,
                scenfile,
                newdfpooling$impact_Median,
                newdfpooling$impact_StandardDeviation,
                newdfpooling$impact_Mean,
                newdfpooling$impact_FirstQuartile,
                newdfpooling$impact_ThirdQuartile,
                newdfpooling$impact_InterquartileRange,
                newdfpooling$impact_Minimum,
                newdfpooling$impact_Maximum,
                newdfpooling$impact_Range,
                newdfpooling$occurrence_Median,
                newdfpooling$occurrence_StandardDeviation,
                newdfpooling$occurrence_Mean,
                newdfpooling$occurrence_FirstQuartile,
                newdfpooling$occurrence_ThirdQuartile,
                newdfpooling$occurrence_InterquartileRange,
                newdfpooling$occurrence_Minimum,
                newdfpooling$occurrence_Maximum,
                newdfpooling$occurrence_Range
  )
  ...
  y.daten <- data.frame(ACCID = integer(), Wert = numeric())
   ...
   classicY_metrics <- calculate_metrics(actual.df$scaled_OCCURRENCE)
    ...
    save_to_latex(actualscenario,
                  ...
                  group,
                  scenfile,
                  newdfclassic$impact_Median,
                  newdfclassic$impact_StandardDeviation,
                  newdfclassic$impact_Mean,
                  newdfclassic$impact_FirstQuartile,
                  newdfclassic$impact_ThirdQuartile,
                  newdfclassic$impact_InterquartileRange,
                  newdfclassic$impact_Minimum,
                  newdfclassic$impact_Maximum,
                  newdfclassic$impact_Range,
                  newdfclassic$occurrence_Median,
                  newdfclassic$occurrence_StandardDeviation,
                  newdfclassic$occurrence_Mean,
                  newdfclassic$occurrence_FirstQuartile,
                  newdfclassic$occurrence_ThirdQuartile,
                  newdfclassic$occurrence_InterquartileRange,
                  newdfclassic$occurrence_Minimum,
                  newdfclassic$occurrence_Maximum,
                  newdfclassic$occurrence_Range
                  )
    ...
    save_to_latex(actualscenario,
                  ...
                  group,
                  scenfile,
                  newdfg5$impact_Median,
                  newdfg5$impact_StandardDeviation,
                  newdfg5$impact_Mean,
                  newdfg5$impact_FirstQuartile,
                  newdfg5$impact_ThirdQuartile,
                  newdfg5$impact_InterquartileRange,
                  newdfg5$impact_Minimum,
                  newdfg5$impact_Maximum,
                  newdfg5$impact_Range,
                  newdfg5$occurrence_Median,
                  newdfg5$occurrence_StandardDeviation,
                  newdfg5$occurrence_Mean,
                  newdfg5$occurrence_FirstQuartile,
                  newdfg5$occurrence_ThirdQuartile,
                  newdfg5$occurrence_InterquartileRange,
                  newdfg5$occurrence_Minimum,
                  newdfg5$occurrence_Maximum,
                  newdfg5$occurrence_Range
    )
    ...
    save_to_latex(actualscenario,
                  ...
                  group,
                  scenfile,
                  newdfg2$impact_Median,
                  newdfg2$impact_StandardDeviation,
                  newdfg2$impact_Mean,
                  newdfg2$impact_FirstQuartile,
                  newdfg2$impact_ThirdQuartile,
                  newdfg2$impact_InterquartileRange,
                  newdfg2$impact_Minimum,
                  newdfg2$impact_Maximum,
                  newdfg2$impact_Range,
                  newdfg2$occurrence_Median,
                  newdfg2$occurrence_StandardDeviation,
                  newdfg2$occurrence_Mean,
                  newdfg2$occurrence_FirstQuartile,
                  newdfg2$occurrence_ThirdQuartile,
                  newdfg2$occurrence_InterquartileRange,
                  newdfg2$occurrence_Minimum,
                  newdfg2$occurrence_Maximum,
                  newdfg2$occurrence_Range
    )
    ...
    save_to_latex(actualscenario,
                  ...
                  group,
                  scenfile,
                  newdfg3$impact_Median,
                  newdfg3$impact_StandardDeviation,
                  newdfg3$impact_Mean,
                  newdfg3$impact_FirstQuartile,
                  newdfg3$impact_ThirdQuartile,
                  newdfg3$impact_InterquartileRange,
                  newdfg3$impact_Minimum,
                  newdfg3$impact_Maximum,
                  newdfg3$impact_Range,
                  newdfg3$occurrence_Median,
                  newdfg3$occurrence_StandardDeviation,
                  newdfg3$occurrence_Mean,
                  newdfg3$occurrence_FirstQuartile,
                  newdfg3$occurrence_ThirdQuartile,
                  newdfg3$occurrence_InterquartileRange,
                  newdfg3$occurrence_Minimum,
                  newdfg3$occurrence_Maximum,
                  newdfg3$occurrence_Range
    )
...
#Graphischer Wert über Flächen & REACHED GRID TEIL & WEIGHT VARIANTE
  ...
  for (i in 1:numberofanswers){
    ...
    save_to_latex(actualscenario,
                  ...
                  group,
                  scenfile,
                  newdfweight$impact_Median,
                  newdfweight$impact_StandardDeviation,
                  newdfweight$impact_Mean,
                  newdfweight$impact_FirstQuartile,
                  newdfweight$impact_ThirdQuartile,
                  newdfweight$impact_InterquartileRange,
                  newdfweight$impact_Minimum,
                  newdfweight$impact_Maximum,
                  newdfweight$impact_Range,
                  newdfweight$occurrence_Median,
                  newdfweight$occurrence_StandardDeviation,
                  newdfweight$occurrence_Mean,
                  newdfweight$occurrence_FirstQuartile,
                  newdfweight$occurrence_ThirdQuartile,
                  newdfweight$occurrence_InterquartileRange,
                  newdfweight$occurrence_Minimum,
                  newdfweight$occurrence_Maximum,
                  newdfweight$occurrence_Range
    )
  ...
  save_to_latex(actualscenario,
                ...
                group,
                scenfile,
                newdfg1$impact_Median,
                newdfg1$impact_StandardDeviation,
                newdfg1$impact_Mean,
                newdfg1$impact_FirstQuartile,
                newdfg1$impact_ThirdQuartile,
                newdfg1$impact_InterquartileRange,
                newdfg1$impact_Minimum,
                newdfg1$impact_Maximum,
                newdfg1$impact_Range,
                newdfg1$occurrence_Median,
                newdfg1$occurrence_StandardDeviation,
                newdfg1$occurrence_Mean,
                newdfg1$occurrence_FirstQuartile,
                newdfg1$occurrence_ThirdQuartile,
                newdfg1$occurrence_InterquartileRange,
                newdfg1$occurrence_Minimum,
                newdfg1$occurrence_Maximum,
                newdfg1$occurrence_Range
  )
...
for (anz in 1:number.scenarios) {
  actualscenario =as.vector(scenarios[anz,1])
  print (actualscenario)
  actual.df <- answers %>% filter(QUES2SURV_METHOD == "classic" & ANS2SURV_ANSWERED == 1 & QUES_ID == actualscenario & ACC2SURV_ROLE == 1)# & ACC2SURV_ACCID == "22")
  actualtype <- actual.df[1,"QUES_TYP"]
  print (actualtype)
  ...
  group <- "coreteam"
  scentext <- (paste0("", actualscenario))
  scenfile <- (paste0("myapp/tex/50_scattering/",scentext,"_core_",method,".tex")) 
...
for (anz in 1:number.scenarios) {
  actualscenario =as.vector(scenarios[anz,1])
  print (actualscenario)
  actual.df <- answers %>% filter(QUES2SURV_METHOD == "classic" & ANS2SURV_ANSWERED == 1 & QUES_ID == actualscenario & ACC2SURV_ROLE == 2)# & ACC2SURV_ACCID == "22")
  actualtype <- actual.df[1,"QUES_TYP"]
  print (actualtype)
...
gerundeter_df <- as.data.frame(lapply(df, runde_wenn_numerisch))
...
write.csv(gerundeter_df, file = paste0("myapp/files/50_scattering/",scentext,".csv"), row.names = TRUE)
